...
This project administration panel is available on [`https://admin.lm.inf.uach.cl`](https://admin.lm.inf.uach.cl).
...
The `Altair GraphQL Web Client` button opens the url [`https://lm.inf.uach.cl/altair`](https://lm.inf.uach.cl/altair), but with an extra authorization parameter to be able to use the api without any restrictions.
...
The `Voyager GraphQL Schema Visualization` just opens [`https://lm.inf.uach.cl/voyager`](https://lm.inf.uach.cl/voyager)
